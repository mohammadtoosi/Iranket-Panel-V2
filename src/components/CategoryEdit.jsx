...
const CategoryEdit = (props) => {
    ...
    useEffect(() => {
        dispatch(CategoryEditModalActions.setNamesArray(selectedCategoryName));
    }, [selectedCategoryName]);

    useEffect(() => {
        dispatch(CategoryEditModalActions.setIDArray(selectedCategory));
    }, [selectedCategory]);
    ...
    const resetListClickHandler = () => {
        ...
        dispatch(CategoryEditModalActions.setIDArray([]));
        dispatch(CategoryEditModalActions.setNamesArray([]));
    };
